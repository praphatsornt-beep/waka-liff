...
CLOSING_MESSAGE = (
    "งานนี้ทำให้เราได้เห็นว่าคอมมูนิตี้การ์ดเกมของเราอบอุ่นแค่ไหน 🌟\n"
    "ขอบคุณที่มาเป็นส่วนหนึ่งของครอบครัว WAKA และทำให้วันนี้พิเศษกว่าที่คิด\n"
    "ไว้เจอกันใหม่ พร้อมเรื่องราวใหม่ ๆ นะครับ/คะ 💛"
)
