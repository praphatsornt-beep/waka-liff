...
### WAKA GYM (ต่างจาก mockup มากที่สุด) — 🚫 ฟีเจอร์ถอดออกทั้งหมดแล้ว 2026-08-14
ถอดโค้ดออกจาก Streamlit/GAS/LIFF ทั้งหมดแล้วตามคำขอเจ้าของร้าน (จะแก้กฎเกณฑ์
ก่อนทำใหม่ในอนาคต) — รายการด้านล่างเก็บไว้เป็น reference ตอนสร้างใหม่ ไม่ใช่
งานที่กำลังทำอยู่ ตาราง Supabase (`wakagym_registrations`, `wakagym_events`,
`player_stats`) ยังอยู่ ไม่ได้ลบข้อมูล
